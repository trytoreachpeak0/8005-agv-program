...
- 改动**以 pull request 的形式交给 Kun Wang**，由他决定合不合。**他同意之后由我方合并**
  （2026-09-08 改的；在那之前是「我方不自行合并」）。PR 仍然是改动到达的方式——它是他
  评审的对象，也是决定被记录下来的地方——变的只是点合并这个动作归谁。**同意仍然必须来自
  他本人**，没有他的同意就合并不在这条授权范围内。改这条的原因是：等那一下点击把已经获得
  同意的工作卡住了。
