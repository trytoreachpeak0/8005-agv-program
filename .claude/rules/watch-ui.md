---
paths:
  - "mes/ingest/csharp/MesIngest.Watch/**"
  - "mes/ingest/csharp/MesIngest.Watch.Prototype/**"
  - "mes/ingest/csharp/MesIngest.Watch.FluentPrototype/**"
  - "mes/ingest/csharp/MesIngest.Watch.UiTests/**"
  - "**/*.xaml"
---
