...
- [[br-013-multi-basket-loading|BR-013 多花篮装载]]：权威花篮数量、完整仓位分配、批量开门及 SUBLOT—仓位占用模型。
- [[br-014-transport-task-types-and-fixed-stations|BR-014 六类任务与固定站点]]：六类搬运类型与五个固定区域站点配置。
